    ...
    public void execute(final JobExecutionContext jobCtx) throws JobExecutionException {
        ...
        try {
            ...
            final ConnectionFactory connFactory = (ConnectionFactory) namingCtx
                    .lookup(dataMap.getString(JmsHelper.JMS_CONNECTION_FACTORY_JNDI));
            ...
            final Destination destination = (Destination) namingCtx.lookup(dataMap.getString(JmsHelper.JMS_DESTINATION_JNDI));
