...
public abstract class SendMailJobAuthTestBase {
    ...
    public void setUp() throws Exception {
        ...
        wiser.getServer()
                .setAuthenticationHandlerFactory(new PlainAuthenticationHandlerFactory(simpleValidator));
        wiser.start();
    ...
    public void testWithAuthentication() throws Exception {
        JobDetail job = newJob(SendMailJob.class).withIdentity("job1"/*, "group1"*/).build();
