 ...
 *
 *
 * InstanceIdGenerator，它将使用系统属性来配置计划程序。要使用system_property值的默认系统属性名称，但可以通过“systemPropertyName”属性指定。
 * 您还可以将属性“postpend”和“prepend”设置为String值，这些值将分别添加到系统属性中的值的开头或结尾。如果没有为属性设置值，则抛出SchedulerException
 *
 * @author Alex Snaps
 */
