...
//    }
    ...
    public void pauseJob(Key key) throws SchedulerException {
        invoke(
            "pauseJob", 
            new Object[] { key.getName()/*, jobKey.getGroup()*/ },
            new String[] { String.class.getName()/*, String.class.getName()*/ });
    }
     ...
     * </p>
     */
    public void pauseJobs(GroupMatcher<Key<?>> matcher) throws SchedulerException {
        String operation = null;
        switch (matcher.getCompareWithOperator()) {
            case EQUALS:
     ...
     */
    @Override
    public void resumeJob(Key jobKey) throws SchedulerException {
        invoke(
            "resumeJob", 
            new Object[] { jobKey.getName()/*, jobKey.getGroup()*/ },
            new String[] { String.class.getName()/*, String.class.getName()*/ });
...
//        invoke(operation, new Object[] { matcher.getCompareToValue() }, new String[] { String.class.getName() });
        invoke(operation, new Object[] { triggerName }, new String[] { String.class.getName() });
    }
...
//     */
//    @SuppressWarnings("unchecked")
//    public Set<JobKey> getJobKeys(final String triggerName) throws SchedulerException {
//        List<JobKey> keys = (List<JobKey>)invoke("getJobNames",new Object[] { triggerName },new String[] { String.class.getName() });
...
//    }
    ...
    @Override
    @SuppressWarnings("unchecked")
    public List<Trigger> getTriggersOfJob(Key jobKey) throws SchedulerException {
        throw new SchedulerException("Operation not supported for remote schedulers.");
    }
...
//            new String[] { String.class.getName(),Calendar.class.getName(), boolean.class.getName(), boolean.class.getName() });
//    }
