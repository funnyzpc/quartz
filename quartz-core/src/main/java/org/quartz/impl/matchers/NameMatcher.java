...
//    }
     ...
     */
    public static  NameMatcher<Key<?>> nameStartsWith(String compareTo) {
        return new NameMatcher<Key<?>>(compareTo, StringOperatorName.STARTS_WITH);
    }
...
//    }
     ...
     */
    public static NameMatcher<Key<?>> triggerNameStartsWith(String compareTo) {
        return NameMatcher.nameStartsWith(compareTo);
    }
...
//    }
     ...
     */
    public static NameMatcher<Key<?>> triggerNameContains(String compareTo) {
        return NameMatcher.nameContains(compareTo);
    }
