...
//    }
     ...
     * @throws IllegalArgumentException if an invalid IntervalUnit is given, or the repeat interval is zero or less.
     */
    public DailyTimeIntervalTriggerImpl(String name, /*String group,*/ TimeOfDay startTimeOfDay, TimeOfDay endTimeOfDay, IntervalUnit intervalUnit, int repeatInterval) {
...
//     * @throws IllegalArgumentException if an invalid IntervalUnit is given, or the repeat interval is zero or less.
//     */
//    public DailyTimeIntervalTriggerImpl(String name, String group, Date startTime,Date endTime,TimeOfDay startTimeOfDay,TimeOfDay endTimeOfDay,IntervalUnit intervalUnit,int repeatInterval) {
//        super(name, group);
//        setStartTime(startTime);
//        setEndTime(endTime);
//        setRepeatIntervalUnit(intervalUnit);
...
//     * @throws IllegalArgumentException if an invalid IntervalUnit is given, or the repeat interval is zero or less.
//     */
//    public DailyTimeIntervalTriggerImpl(String name, /*String group, String jobName, String jobGroup,*/ Date startTime, Date endTime, TimeOfDay startTimeOfDay, TimeOfDay endTimeOfDay, IntervalUnit intervalUnit,  int repeatInterval) {
...
//    }
    ...
    public Date computeFirstFireTime(org.quartz.Calendar calendar) {
      ...
      // Check calendar for date-time exclusion 检查日历的日期时间排除
      while (nextFireTime != null && calendar != null && !calendar.isTimeIncluded(nextFireTime.getTime())) {
          nextFireTime = getFireTimeAfter(nextFireTime);
          if(nextFireTime == null){
              break;
