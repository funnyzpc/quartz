...
//
//        this.fJobDetail = new JobDetailImpl("job1", MyJob.class);
...
//            new SimpleTriggerImpl("trigger1",/*this.fJobDetail.getName(),*/ new Date(baseFireTime + 200000), new Date(baseFireTime + 200000), 2, 2000);
//        OperableTrigger trigger2 =
//            new SimpleTriggerImpl("trigger2", /*this.fJobDetail.getName(),*/
//                  new Date(baseFireTime +  50000),
//                    new Date(baseFireTime + 200000), 2, 2000);
//        OperableTrigger trigger3 =
//            new SimpleTriggerImpl("trigger1",/* this.fJobDetail.getName(),*/
...
//        OperableTrigger tr = new SimpleTriggerImpl(trName , new Date());
////        tr.setJobKey(new JobKey(jobName/*, jobGroup*/));
//        tr.setKey(new Key(jobName/*, jobGroup*/));
...
//        tr.setKey(new Key(jobName2/*, jobGroup*/));
//    	fJobStore.storeTrigger(tr, false);
...
//		for (int i=0; i < 10; i++) {
////            String group =  i < 5 ? "a" : "b";
//			Key jobKey = Key.key("job" + i/*, group*/);
...
//			Assert.assertEquals(jobKey, storedJob.getKey());
//
//			Key triggerKey = Key.key("job" + i/*, group*/);
...
//        store.storeJob(job, true);
//        SimpleScheduleBuilder schedule = SimpleScheduleBuilder.simpleSchedule();
//        Trigger trigger = TriggerBuilder.newTrigger().withIdentity("trig1").withSchedule(schedule).forJob(job).build();
//        store.storeTrigger((OperableTrigger) trigger, true);
//
//        job = JobBuilder.newJob(MyJob.class).withIdentity("job1").build();
//        store.storeJob(job, true);
//        schedule = SimpleScheduleBuilder.simpleSchedule();
//        trigger = TriggerBuilder.newTrigger().withIdentity("trig1").withSchedule(schedule).forJob(job).build();
//        store.storeTrigger((OperableTrigger)trigger, true);
//
//        job = JobBuilder.newJob(MyJob.class).withIdentity("job2").build();
//        store.storeJob(job, true);
//        schedule = SimpleScheduleBuilder.simpleSchedule();
//        trigger = TriggerBuilder.newTrigger().withIdentity("trig2").withSchedule(schedule).forJob(job).build();
//        store.storeTrigger((OperableTrigger)trigger, true);
//
////        Set<JobKey> jkeys = store.getAllJobKeysInSched(GroupMatcher.anyJobGroup());
...
//			store.removeJob(triggers.get(0).getKey());
//		}
//	}
//
