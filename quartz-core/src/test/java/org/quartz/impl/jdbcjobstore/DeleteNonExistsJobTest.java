...
public class DeleteNonExistsJobTest {
    ...
    public void deleteJobDetailOnly() throws Exception {
        JobDetail jobDetail = JobBuilder.newJob(TestJob.class).withIdentity("testjob")
//                .storeDurably()
                .build();
    ...
    public void deleteJobDetailWithTrigger() throws Exception {
        JobDetail jobDetail = JobBuilder.newJob(TestJob.class).withIdentity("testjob2")
//                .storeDurably()
                .build();
    ...
    public void deleteTrigger() throws Exception {
        JobDetail jobDetail = JobBuilder.newJob(TestJob.class).withIdentity("testjob3")
//                .storeDurably()
                .build();
...
//                .storeDurably()
        ...
        jobDetail = JobBuilder.newJob(TestJob.class).withIdentity("testjob3")
//                .storeDurably()
                .build();
        scheduler.addJob(jobDetail, true);
    }
