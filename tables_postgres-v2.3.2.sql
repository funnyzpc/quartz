...
COMMENT ON TABLE QRTZ_SIMPROP_TRIGGERS IS '存储CalendarIntervalTrigger和DailyTimeIntervalTrigger两种类型的触发器';
...
COMMENT ON TABLE QRTZ_BLOB_TRIGGERS IS '以Blob类型存储的Trigger';
